...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  data: {
    ...
    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get(apiPath + "blocks").then(function (response) {
      _this.stipends.options = response.data;
    });
  },
  methods: {
    addBlock: function addBlock() {
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post(apiPath + "blocks", {
        block_identifier: this.stipends.newBlock

      });
    },
    removeBlock: function removeBlock(block_identifier) {
      alert(this.block_identifier);
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.delete(apiPath + "blocks", {
  ...
  data: {
    ...
    siteOptions: [{ text: 'Ottawa General Hospital', value: 'TOH' }, { text: 'Children Hospital of Eastern Ontario', value: 'Cheo' }, { text: 'Montfort', value: 'MFT' }]
  }
}), new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#claim-type',
  data: {
  ...
  methods: {
    addClaim: function addClaim() {
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post(apiPath + "claim_type", {
        name: this.stipends.newClaim

      }).then(this.$swal("Good job!", "You clicked the button!", "success"));
    }
  }
}), new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#claim-list',
  data: {
    ...
    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get(apiPath + "master_claims").then(function (response) {
      _this4.claimOptions = response.data;
    });
  },
  computed: {
  ...
  methods: {
    ...
    addStipends: function addStipends() {
      ...
      __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post(apiPath + "master_claims", {
    ...
    checkInHospitalClaimRule: function checkInHospitalClaimRule() {
...
}), __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('demo-grid', {
...
var demo = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  computed: {
    clickClaims: function clickClaims() {
      this.searchQuery = "";
    },
    clickApproved: function clickApproved() {
      this.searchQuery = "true";
    },
    clickDeclined: function clickDeclined() {
        ...
        _c("div", { staticClass: "navbar-header" }, [
          ...
          _c(
            "a",
            {
              ...
              attrs: { href: "#", alt: "Faculty of medicine" }
            },
            [
              _c("img", {
                attrs: {
                  id: "uottawa-logo",
                  src:
                    "https://med.uottawa.ca/sites/all/themes/custom/uottawa_zen_assets/global_header/images/uOttawa-logo.png"
                }
              })
            ]
          )
  ...
  return _c("div", { staticClass: "container" }, [
    _c("form", [
      ...
      _c("div", { staticClass: "form-group" }, [
        _c(
          "label",
          { staticClass: "control-label ", attrs: { for: "block-number" } },
          [_vm._v("Block Number / Numéro de bloc")]
        ),
        _vm._v(" "),
        _c(
          "select",
          ...
          _vm._l(_vm.block.options, function(option) {
        ...
        _vm._v(" "),
        _c("span", [_vm._v("Selected: " + _vm._s(_vm.block.selected))])
      ]),
      _vm._v(" "),
      _vm._m(2),
      _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c("label", { staticClass: "control-label ", attrs: { for: "name" } }, [
        _vm._v("Rasident Name / Nom du résident")
      ]),
      _vm._v(" "),
      _c("input", {
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        {
          staticClass: "control-label requiredField",
          attrs: { for: "submission-date" }
        },
        [
          _vm._v("Claim Submission Date / Date de la demande"),
          _c("span", { staticClass: "asteriskField" }, [_vm._v("*")])
        ]
      ),
      _vm._v(" "),
      _c("input", {
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "control-label ", attrs: { for: "service-name" } },
        [_vm._v("MTD Service Name / Nom du service")]
      ),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "control-label ", attrs: { for: "site-name" } },
        [_vm._v("MTD Site Name / Nom du site")]
      ),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "control-label ", attrs: { for: "claim-date" } },
        [_vm._v("Claim Date / Date de réclamation")]
      ),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
        attrs: { id: "claim-date", name: "claim-date", type: "date" }
      })
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "control-label ", attrs: { for: "claim-type" } },
        [_vm._v("Claim Type / Type de réclamation")]
      ),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
        attrs: { id: "claim-date", name: "claim-date", type: "select" }
      })
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c(
        "label",
        { staticClass: "control-label ", attrs: { for: "claim-type" } },
        [_vm._v("Earning Code / Code de rénumération")]
      ),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
