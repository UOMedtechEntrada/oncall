...
class Carbon extends DateTime
{
    ...
    public static function create($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
    {
        ...
        $defaults = array_combine(array('year', 'month', 'day', 'hour', 'minute', 'second'), explode('-', $now->format('Y-n-j-G-i-s')));
    ...
    {
        static $formats = array('year' => 'Y', 'yearIso' => 'o', 'month' => 'n', 'day' => 'j', 'hour' => 'G', 'minute' => 'i', 'second' => 's', 'micro' => 'u', 'dayOfWeek' => 'w', 'dayOfYear' => 'z', 'weekOfYear' => 'W', 'daysInMonth' => 't', 'timestamp' => 'U');
        switch (true) {
    ...
    public static function setLocale($locale)
    {
        ...
        if (file_exists($filename = '/home/entrada/public_html/laravel-5.0-master/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php')) {
    ...
    public function diffForHumans(self $other = null, $absolute = false, $short = false, $parts = 1)
    {
        ...
        $diffIntervalArray = array(array('value' => $diffInterval->y, 'unit' => 'year', 'unitShort' => 'y'), array('value' => $diffInterval->m, 'unit' => 'month', 'unitShort' => 'm'), array('value' => $diffInterval->d, 'unit' => 'day', 'unitShort' => 'd'), array('value' => $diffInterval->h, 'unit' => 'hour', 'unitShort' => 'h'), array('value' => $diffInterval->i, 'unit' => 'minute', 'unitShort' => 'min'), array('value' => $diffInterval->s, 'unit' => 'second', 'unitShort' => 's'));
