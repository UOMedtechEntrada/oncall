set :application, "oncall"

set :repository, "git@github.com:UOMedtechEntrada/oncall.git"
set :scm, :git
...
# Entrada ME
task :staging do
  server "entradastaging.med.uottawa.ca", :app, :web, :db, :primary => true

  set :user, "oncall"

  set :branch, "feature/staging"
  set :environment, "staging"
  set :deploy_to, "/var/www/apps/oncall"
  set :app_symlink, "/var/www/html/oncall"
end
task :production do
  ...
  namespace :web do
    ...
    task :enable do
      ...
      if environment == "staging"
        run "curl -s https://entradastaging.med.uottawa.ca/cbme/cron/opcache_reset.php"
      end
